...
<head>
    ...
    <title>Portal Pengirim - SIM Logistik</title>
    ...
    <div class="w-full max-w-[400px] bg-white min-h-screen relative shadow-2xl overflow-hidden flex flex-col border-x border-gray-100">
        ...
        <div class="img-hero-container">
            <div class="p-6">
                ...
                <img src="penjual.png" class="h-52 w-52 object-contain" alt="Logistik Pengirim" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2300/2300326.png'">
            </div>
        </div>


        <div class="px-8 py-6 flex-1 flex flex-col justify-center text-center">
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight leading-tight">Siap Kirim Paket <br>Hari Ini?</h1>
            <p class="text-gray-500 text-[14px] mt-3 leading-relaxed">
                Daftarkan detail pesanan pelanggan Anda ke sistem, dapatkan nomor resi otomatis, dan pantau perjalanan paket hingga sampai ke tujuan.
            </p>
        </div>
