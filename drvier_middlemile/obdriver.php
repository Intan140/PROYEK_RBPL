...
<head>
    ...
    <title>Onboarding Driver - SIM Logistik</title>
    ...
    <div class="w-full max-w-[400px] bg-white min-h-screen relative shadow-2xl overflow-hidden flex flex-col border-x border-gray-100">
        ...
        <div class="img-hero-container">
            <div class="p-6">
                ...
                <img src="driver_middle.png" class="h-52 w-52 object-contain" alt="Ilustrasi Driver Truk" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2554/2554978.png'">
            </div>
        </div>

        <div class="px-8 py-6 flex-1 flex flex-col justify-center text-center">
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight leading-tight">Driver <br>Middle Mile</h1>
            <p class="text-gray-500 text-[14px] mt-3 leading-relaxed">
                Terima rute antar-hub, konfirmasi jadwal keberangkatanmu, dan update status tiba dengan aman.
            </p>
        </div>
        ...
        <div class="p-8 pb-10 flex gap-3">
            ...
            <button onclick="window.location.href='driver.php'" class="flex-1 shopee-bg text-white py-4 rounded-xl font-bold text-lg shadow-[0_10px_20px_-10px_rgba(238,77,45,0.6)] active:scale-95 transition-all text-center">
                Mulai
            </button>
        </div>
    </div>
