...
<head>
    ...
    <title>Onboarding Koordinator - SIM Logistik</title>
    ...
    <div class="w-full max-w-[400px] bg-white min-h-screen relative shadow-2xl overflow-hidden flex flex-col border-x border-gray-100">
        ...
        <div class="img-hero-container">
            <div class="p-6">
                ...
                <img src="koor_hubreg.png" class="h-52 w-52 object-contain" alt="Analisis Data" onerror="this.src='https://cdn-icons-png.flaticon.com/512/3241/3241517.png'">
            </div>
        </div>

        <div class="px-8 py-6 flex-1 flex flex-col justify-center text-center">
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight leading-tight">Koordinator HUB</h1>
            <p class="text-gray-500 text-[14px] mt-3 leading-relaxed">
                Kendali penuh operasional HUB Last Mile. Pantau performa kurir dan pastikan target SLA tercapai.
            </p>
        </div>
