...
<head>
    ...
    <title>Onboarding Kurir - SIM Logistik</title>
...
<body class="flex justify-center items-start min-h-screen">
    <div class="w-full max-w-[400px] bg-white min-h-screen relative shadow-2xl overflow-hidden flex flex-col border-x border-gray-100">
        ...
        <div class="img-hero-container relative">
            ...
            <div class="p-6 z-10">
                <img src="kurir.png" class="h-52 w-52 object-contain filter drop-shadow-xl" alt="Ilustrasi Kurir Last Mile" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2972/2972185.png'">
            </div>
        </div>

        <div class="px-8 py-6 flex-1 flex flex-col justify-center text-center">
            <h1 class="text-[26px] font-extrabold text-gray-800 tracking-tight font-poppins leading-tight">Siap Kirim Paket, <br>Kurir Hebat?</h1>
            <p class="text-gray-500 text-[14px] mt-3 leading-relaxed text-center px-2">
                Sortir paket per kecamatan, bagi rute pengiriman, dan update status pengiriman secara real-time dengan mudah.
            </p>
        </div>

        <div class="p-8 pb-8 flex gap-3">
            <button onclick="window.location.href='../onboarding.php'" class="flex-1 bg-white border-2 border-[#F66341] text-[#F66341] py-4 rounded-2xl font-bold text-[15px] active:scale-95 transition-all text-center">
                Kembali
            </button>
            <button onclick="window.location.href='dashboard.php'" class="flex-1 shopee-bg text-white py-4 rounded-2xl font-bold text-[15px] shadow-[0_10px_20px_-10px_rgba(246,99,65,0.6)] active:scale-95 transition-all text-center">
                Mulai
            </button>
        </div>
