...
<head>
    ...
    <title>Onboarding Sortasi - SIM Logistik</title>
    ...
    <div class="w-full max-w-[400px] bg-white min-h-screen relative shadow-2xl overflow-hidden flex flex-col border-x border-gray-100">
        ...
        <div class="img-hero-container">
            <div class="p-6">
                ...
                <img src="operator_sortationcenter.png" class="h-52 w-52 object-contain" alt="Ilustrasi Operator Sortasi" onerror="this.src='https://cdn-icons-png.flaticon.com/512/3067/3067451.png'">
            </div>
        </div>

        <div class="px-8 py-6 flex-1 flex flex-col justify-center text-center">
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight leading-tight">Halo, <br>Operator Sortasi!</h1>
            <p class="text-gray-500 text-[14px] mt-3 leading-relaxed">
                Pastikan setiap paket masuk ke area bagging yang tepat. Ketelitian Anda adalah kunci kecepatan pengiriman.
            </p>
        </div>
        <div class="p-8 pb-10 flex gap-3">
            ...
            <button onclick="window.location.href='sortir.php'" class="flex-1 shopee-bg text-white py-4 rounded-xl font-bold text-lg shadow-[0_10px_20px_-10px_rgba(238,77,45,0.6)] active:scale-95 transition-all text-center">
                Mulai
            </button>
        </div>
    </div>
