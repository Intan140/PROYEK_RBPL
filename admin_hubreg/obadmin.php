...
<head>
    ...
    <title>Onboarding Admin - SIM Logistik</title>
    ...
    <div class="w-full max-w-[400px] bg-white min-h-screen relative shadow-2xl overflow-hidden flex flex-col border-x border-gray-100">
        ...
        <div class="img-hero-container">
            <div class="p-6">
                ...
                <img src="admin_hubreg.png" class="h-52 w-52 object-contain" alt="Admin Hub Regional" onerror="this.src='https://cdn-icons-png.flaticon.com/512/3534/3534139.png'">
            </div>
        </div>

        <div class="px-8 py-6 flex-1 flex flex-col justify-center text-center">
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight leading-tight">Admin <br>Hub Regional</h1>
            <p class="text-gray-500 text-[14px] mt-3 leading-relaxed">
                Pantau pergerakan armada besar dan jadwal keberangkatan antar gudang wilayah secara real-time.
            </p>
        </div>
        ...
        <div class="p-8 pb-10 flex gap-3">
            ...
            <button onclick="window.location.href='input.php'" class="flex-1 shopee-bg text-white py-4 rounded-xl font-bold text-lg shadow-[0_10px_20px_-10px_rgba(238,77,45,0.6)] active:scale-95 transition-all text-center">
                Masuk
            </button>
        </div>
    </div>
